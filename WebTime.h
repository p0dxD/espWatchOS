...
/*
 * (C) Francesco Potortì 2013 - GPLv3
 *
 * Sends an HTTP packet to http://g.cn (google) and waits for the response,
 * then returns the contained time as a unix timestamp.
 *
 * Original: https://playground.arduino.cc/Code/Webclient
 */
